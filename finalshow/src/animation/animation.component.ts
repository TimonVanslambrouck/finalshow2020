...
export class AnimationComponent implements OnInit {
 ...
 //orbit=new ORBIT.OrbitControls(this.camera,this.renderer.domElement);
  ...
  loadModels(){
    ...
    this.modelLoader.loadModel(this.loader, this.scene,'../assets/3D_models/drone/DroneAllInOne.glb',"drone", 2.5,[0,0,0],[0,-130,450]);
 //   this.modelLoader.loadModel(this.scene,'../assets/3D_models/cloud/scene.gltf',"cloud");
    ...
    this.modelLoader.loadModel(this.loader, this.scene,'../assets/3D_models/balloon/android.glb',"android",7,[0,0,0],[150,-100,400]);
